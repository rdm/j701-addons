require 'gl2 pack general/misc/font'
...
if. IFQT do.
  ...
  make_window''
  destroy=: gridpdestroy
  gtk_widget_show_jgtk_ window
  gtk_window_get_size_jgtk_ window ; (w=. ,_1) ; (h=. ,_1)
  wh=. w,h
  grid=: '' conew 'jzgrid'
  GRIDPID=: 'gridp'
  GRIDID=: 'grid'
...
make_window=: 3 : 0
window=: gtk_window_new_jgtk_ 0
gtk_window_set_title_jgtk_ window;'Grid'
consig3_jgtk_ window;'delete-event';'gridpdestroy';coname''
canvas=: glcanvas_jgl2_ 800 600;coname''
gtk_container_add_jgtk_ window,canvas
)
coclass 'jzgrid'
axmbldown=: 3 : 0
if. State = iACombo do.
