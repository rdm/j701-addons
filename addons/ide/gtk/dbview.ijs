require 'general/misc/font gl2 grid jzgrid pack'
...
jdbview_run=: 3 : 0
vhwndp=: gtk_window_new_jgtk_ 0
gtk_window_set_position_jgtk_ vhwndp, GTK_WIN_POS_CENTER
consig_jgtk_ vhwndp;'destroy';'jdbviewdestroy';coname''
canvas=: glcanvas_jgl2_ 800 600;coname''
gtk_container_add_jgtk_ vhwndp, canvas
GRIDHWNDC=: canvas
GRIDPID=: 'dbview'
GRIDID=: 'grid'
gtk_widget_show_jgtk_ vhwndp
grid=: '' conew 'jzgrid'
show__grid GRIDNAMES, ' GRIDPID GRIDID GRIDHWNDC'
)
jdbviewdestroy=: 3 : 0
gtk_widget_destroy_jgtk_ ::0: vhwndp
destroy__grid''
codestroy''
)
jdbview=: 3 : 0
