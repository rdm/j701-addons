...
if. RepaintFocus do. repaintwindows'' end.
0
)
readwinpos=: 3 : 0
...
repaintwindows=: 3 : 0
locs=. (gtklocs_jgtkide_'') intersect conl 1
for_loc. locs do.
  gtk_widget_queue_draw window__loc
end.
0
)
runlines=: runimmex1
...
browse 'http://www.gtk.org/documentation.php'
0
)
...
htmlhelpbaselib=: 3 : 0
  if. fexist f=. jpath '~.Main/', y do.
    ...
    browse_j_ 'http://www.jsoftware.com/wsvn/base7/trunk/', y
  end.
0
)
htmlhelpgtk=: 3 : 0
...
if. IFWIN do. gtk_print_operation_set_unit operation;GTK_UNIT_POINTS end.
